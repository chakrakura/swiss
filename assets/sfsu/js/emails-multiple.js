(function( $ ){
	...
	$.fn.multiple_emails = function(options) {
		...
		{
			deleteIconHTML = '<a href="#" class="multiple_emails-close" title="Remove"><span class="icon icon-remove"></span></a>';
		}
		...
		return this.each(function() {
			...
			var $input = $('<input type="text" class="multiple_emails-input text-left" />').on('keydown', function(e) { // input
