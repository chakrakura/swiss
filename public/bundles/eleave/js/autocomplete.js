...
var _adresseRecherche = "search_user" //l'adresse à interroger pour trouver les suggestions
...
function setCompleteDivSize(){
  if(_completeDiv){
	...
	_completeDiv.style.width="255px";	
    if (navigator.appName=="Netscape") _completeDiv.style.width=calculateWidth()+"px";	
  }
}
