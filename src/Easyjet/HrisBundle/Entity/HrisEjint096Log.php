 ...
 * HrisRow
 *
 * @ORM\Table(name="HRIS_EJINT096_LOG")
 * @ORM\Entity(repositoryClass="App\Easyjet\HrisBundle\Repository\HrisEjint096Repository")
 */

class HrisEjint096Log
{
     ...
     * @var string
     *
     * @ORM\Column(name="pay_elements_log", type="text", nullable=false)
     */
    private $payElementsLog;
