 ...
 * @final
 */
class MySwitchUserListener  extends AbstractListener
{
    ...
    private function attemptSwitchUser(Request $request, string $username): ?TokenInterface
    {
        ...
        \App\Easyjet\SwissinsideCoreBundle\Classes\Roles::getForUser($user, $this->em);
        $roles = $user->getRoles();
