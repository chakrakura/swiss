...
{
    /**
     * Gets the private 'App\Easyjet\EwishBundle\Repository\CalendrierRepository' shared autowired service.
     *
     * @return \App\Easyjet\EwishBundle\Repository\CalendrierRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Easyjet'.\DIRECTORY_SEPARATOR.'EwishBundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CalendrierRepository.php';

        return $container->privates['App\\Easyjet\\EwishBundle\\Repository\\CalendrierRepository'] = new \App\Easyjet\EwishBundle\Repository\CalendrierRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
