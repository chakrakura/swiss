 ...
 */
class getRefusRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Easyjet\EleaveBundle\Repository\RefusRepository' shared autowired service.
     *
     * @return \App\Easyjet\EleaveBundle\Repository\RefusRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Easyjet'.\DIRECTORY_SEPARATOR.'EleaveBundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RefusRepository.php';

        return $container->privates['App\\Easyjet\\EleaveBundle\\Repository\\RefusRepository'] = new \App\Easyjet\EleaveBundle\Repository\RefusRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
