...
{
    /**
     * Gets the private 'App\Easyjet\EleaveBundle\Repository\WishRepository' shared autowired service.
     *
     * @return \App\Easyjet\EleaveBundle\Repository\WishRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Easyjet'.\DIRECTORY_SEPARATOR.'EleaveBundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'WishRepository.php';

        return $container->privates['App\\Easyjet\\EleaveBundle\\Repository\\WishRepository'] = new \App\Easyjet\EleaveBundle\Repository\WishRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
