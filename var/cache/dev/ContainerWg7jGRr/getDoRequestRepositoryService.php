 ...
 */
class getDoRequestRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Easyjet\EwishBundle\Repository\DoRequestRepository' shared autowired service.
     *
     * @return \App\Easyjet\EwishBundle\Repository\DoRequestRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Easyjet'.\DIRECTORY_SEPARATOR.'EwishBundle'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'DoRequestRepository.php';

        return $container->privates['App\\Easyjet\\EwishBundle\\Repository\\DoRequestRepository'] = new \App\Easyjet\EwishBundle\Repository\DoRequestRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
