 ...
 */
class TypesEftr extends \App\Easyjet\UmanBundle\Entity\TypesEftr implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'id', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'type', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'salaireBase', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'salaireBase3PremiersMois', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'paiementSecteursBase', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'employeeType', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'typeLabel', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'responsable', '' . "\0" . 'App\\Easyjet\\UmanBundle\\Entity\\TypesEftr' . "\0" . 'activeType'];
        }
    ...
    public function setActiveType($activeType)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setActiveType', [$activeType]);

        return parent::setActiveType($activeType);
    }
    ...
    public function getActiveType()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getActiveType', []);
